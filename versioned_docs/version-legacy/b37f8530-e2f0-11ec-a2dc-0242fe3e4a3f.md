---
id: "b37f8530-e2f0-11ec-a2dc-0242fe3e4a3f"
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">Spy Web Utility provides an intelligent object capturing   capability on websites. To learn more about this utility, see <a className="xref" href="/docs/legacy/katalon-studio-enterprise/test-design/web-test-design/web-record-and-spy-utilities/spy-web-utility">Spy     Web Utility</a>.</p> 
