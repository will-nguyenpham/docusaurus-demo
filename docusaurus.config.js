    ...
    [
      ...
      // highlight-start
      {
        redirects: [
          ...
          {
              to: "/docs/katalon-studio-enterprise/keywords/windows-keywords/windows-switch-to-window_1",
              from: [
          ...
          {
              to: "/docs/katalon-studio-enterprise/keywords/windows-keywords/windows-switch-to-window-title_1",
              from: [
        ...
        {
            to: "/docs/katalon-testcloud-trial/get-started/integration-with-studio",
            from: [
                "/katalon-studio/docs/testcloud-integration.html"
            ]
        },
