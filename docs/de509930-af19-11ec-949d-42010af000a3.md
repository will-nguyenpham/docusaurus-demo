---
id: "de509930-af19-11ec-949d-42010af000a3"
title: "[WebUI] Get Window Title"
slug: "katalon-studio-enterprise/keywords/web-ui-keywords/webui-get-window-title"
hide_title: true
---
...
<table xmlns="http://www.w3.org/1999/xhtml" className="table"><caption /><thead className="thead"><tr className><th className="entry anchor_top_offset" id="id_0__id_3__entry__1">Param Type</th><th className="entry anchor_top_offset" id="id_0__id_3__entry__2">Description</th></tr></thead><tbody className="tbody"><tr className><td className="entry" headers="id_0__id_3__entry__1 id_0__id_3__entry__2 ">String</td><td className="entry" headers="id_0__id_3__entry__1 id_0__id_3__entry__2 ">Title of the current window.</td></tr></tbody></table> 
