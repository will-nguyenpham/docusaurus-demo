...
<div xmlns="http://www.w3.org/1999/xhtml" className="p">You can integrate Jenkins with Katalon Studio and execute Katalon tests with Jenkins.<div className="note attention note_attention"><span className="note__title">Attention:</span> <ul className="ul"><li className="li"><p className="p">The Katalon plugin is currently not available on Jenkins. You can refer to the workaround for this issue on our Support Portal: <a className="xref j-external-link" href="https://katalonsupport.force.com/katalonhelpcenter/s/article/Katalon-Plugin-issue-on-Jenkins" target="_blank">Katalon Plugin issue on Jenkins</a>.</p></li></ul></div></div>
