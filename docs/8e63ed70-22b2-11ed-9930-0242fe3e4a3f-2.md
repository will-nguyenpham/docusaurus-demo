...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">You can link a Test Run to a Build (or a Release). See: <a className="xref" href="/docs/test-planning/link-test-runs-to-a-release-in-katalon-testops">Link Test Runs to a Release</a>.</p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">See also: <a className="xref" href="/docs/test-planning/create-and-edit-releases-in-testops">Manage Test Runs by Release</a>.</p> 
