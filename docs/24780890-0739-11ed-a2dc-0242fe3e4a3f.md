---
id: "24780890-0739-11ed-a2dc-0242fe3e4a3f"
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">In version 7.6, Katalon Studio fully support <a className="xref" href="#">selector     strategies supported by Appium except for Android Data     Matcher</a>.</p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">Katalon Studio 7.6+ fully supports <a className="xref" href="#">selector strategies supported by Appium except for Android Data Matcher</a>.</p> 
