...
slug: "test-generation/manage-projects/set-up-projects/mobile-testing/testing-web-app-on-mobile-browsers-in-katalon-studio"
hide_title: true
---
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">It requires some knowledge of working with OS, Appium, and   devices in use. Please refer to our Mobile Setup guide    for <a className="xref" href="/docs/test-generation/manage-projects/set-up-projects/mobile-testing/android/mobile-android-setup-in-katalon-studio">Android</a> and <a className="xref" href="/docs/test-generation/manage-projects/set-up-projects/mobile-testing/ios/mobile-ios-setup-real-devices-in-katalon-studio">iOS</a> for  detailed instructions.</p> 
