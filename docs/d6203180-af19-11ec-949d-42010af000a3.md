---
id: "d6203180-af19-11ec-949d-42010af000a3"
title: "[Mobile] Get Element Left Position"
slug: "katalon-studio-enterprise/keywords/mobile-keywords/mobile-get-element-left-position"
hide_title: true
---
...
<table xmlns="http://www.w3.org/1999/xhtml" className="table"><caption /><thead className="thead">     <tr className>       <th className="entry anchor_top_offset" id="id_0__id_3__entry__1">Param Type</th>       <th className="entry anchor_top_offset" id="id_0__id_3__entry__2">Description</th>     </tr>   </thead><tbody className="tbody">     <tr className>       <td className="entry" headers="id_0__id_3__entry__1 id_0__id_3__entry__2 ">int</td>       <td className="entry" headers="id_0__id_3__entry__1 id_0__id_3__entry__2 ">The left position of the mobile element.</td>     </tr>   </tbody></table> 
