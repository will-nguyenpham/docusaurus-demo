...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">To learn more about how to use this plugin, see&nbsp;<a className="xref" href="/test-management/manage-tests/dynamic-test-suite/basic-search-for-dynamic-test-suite">Basic Search For Dynamic Test Suite</a>.</p> 
