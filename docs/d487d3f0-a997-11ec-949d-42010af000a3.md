---
id: "d487d3f0-a997-11ec-949d-42010af000a3"
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">It requires some knowledge of working with OS, Appium, and   devices in use. Please refer to our Mobile Setup guide <a className="xref j-external-link" href="http://docs.katalon.com/x/jwbR" target="_blank">for Windows</a>, or <a className="xref j-external-link" href="http://docs.katalon.com/x/9AXR" target="_blank">for macOS</a>   for detailed instructions.</p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">   <img className="image" src={useBaseUrl("https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/tutorials/running_application_mobile_browsers/test-steps.png")} width={850} alt="test steps" /><br /><br /> </p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">   <img className="image" src={useBaseUrl("https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/tutorials/running_application_mobile_browsers/execution.png")} width={850} alt="execution" /><br /><br /> </p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">For further instructions and help, please refer to the <a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/overview.html" target="_blank">Overview of Documentation</a> or <a className="xref j-external-link" href="https://forum.katalon.com/" target="_blank">Katalon Forum</a>.</p> 
