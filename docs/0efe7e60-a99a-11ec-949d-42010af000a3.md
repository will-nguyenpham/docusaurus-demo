---
id: "0efe7e60-a99a-11ec-949d-42010af000a3"
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">Katalon Studio version <strong className="ph b">7.8 onwards</strong> supports screen-based recording and <a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/record-browser-based-videos.html" target="_blank">browser-based recording</a>.</p> 
