...
title: "Overview"
slug: "plugins-and-addons/katalium-framework/overview"
hide_title: true
---
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">For detailed instructions, you can refer to this document: <a className="xref" href="/plugins-and-addons/katalium-framework/get-started/in-visual-studio-code">Get Started with Katalium Framework in Visual Studio Code</a></p> 
