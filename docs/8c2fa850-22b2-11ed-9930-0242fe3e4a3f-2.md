...
slug: "administration/administration-tasks/create-an-organization-and-project"
hide_title: true
---
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">See: <a className="xref" href="/docs/administration/administration-tasks/user-management/transfer-ownership">Transfer     Ownership</a>.</p> 
