---
id: "d90d9840-a999-11ec-949d-42010af000a3"
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">For further instructions and help, refer to <a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/webui-accept-alert.html#description" target="_blank">WebUI Alert</a>and <a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/pop_up_dialog_issue.html" target="_blank">Solving pop-up dialog issue with Katalon Studio</a>.</p> 
