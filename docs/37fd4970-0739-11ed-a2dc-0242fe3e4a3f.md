---
id: "37fd4970-0739-11ed-a2dc-0242fe3e4a3f"
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" src={useBaseUrl("/3808bb20-0739-11ed-a2dc-0242fe3e4a3f.png")} alt="Sample POST request" /></p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" src={useBaseUrl("/381bf500-0739-11ed-a2dc-0242fe3e4a3f.png")} alt="View the verification steps in the log viewer" /></p> 
