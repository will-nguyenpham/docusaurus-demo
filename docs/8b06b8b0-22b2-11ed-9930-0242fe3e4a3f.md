...
title: "Link test execution with a TestOps release using via Command Builder in Katalon Studio"
slug: "test-planning/link-test-execution-with-a-testops-release-using-via-command-builder-in-katalon-studio"
hide_title: true
---
import useBaseUrl from '@docusaurus/useBaseUrl';


# <a id="id_execution-release-cli" class="anchor_top_offset"/><a id="ariaid-title1" class="anchor_top_offset"/>Link test execution with a TestOps release using via Command Builder in <span xmlns="http://www.w3.org/1999/xhtml" className="ph">Katalon Studio</span> 
