...
slug: "test-generation/test-objects/web-test-objects/manage-web-test-objects"
hide_title: true
---
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">Moreover, you can capture objects using Web <a className="xref" href="/test-generation/record-and-spy/webui-record-and-spy-utilities/spy-web-utility">Spy</a>   or <a className="xref" href="/test-generation/record-and-spy/webui-record-and-spy-utilities/record-web-utility">Recorder</a>.</p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">Image locators allow you to identify test objects with images   and perform web image-based testing. Learn more at <a className="xref" href="/test-generation/test-objects/web-test-objects/web-image-based-testing">Web     Image-based Testing</a>.</p> 
...
<ul xmlns="http://www.w3.org/1999/xhtml" className="ul">   <li className="li">     <a className="xref" href="/test-generation/test-objects/web-test-objects/web-image-based-testing">Using       the built-in feature in Web Recorder and Spy</a>   </li>   <li className="li">     <a className="xref" href="/test-generation/test-objects/web-test-objects/web-image-based-testing">Using       a manual way</a>   </li> </ul> 
