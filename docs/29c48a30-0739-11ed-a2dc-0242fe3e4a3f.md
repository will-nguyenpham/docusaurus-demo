---
id: "29c48a30-0739-11ed-a2dc-0242fe3e4a3f"
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" width={500} src={useBaseUrl("/29dd4250-0739-11ed-a2dc-0242fe3e4a3f.png")} alt="create a new test case" /></p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" width={350} src={useBaseUrl("/29eb7320-0739-11ed-a2dc-0242fe3e4a3f.png")} alt="record web" /></p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" width={700} src={useBaseUrl("/29f9a3f0-0739-11ed-a2dc-0242fe3e4a3f.png")} alt="record web" /></p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" width={600} src={useBaseUrl("/f4c5cc40-0738-11ed-a2dc-0242fe3e4a3f.png")} alt="select browser" /> </p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" width={700} src={useBaseUrl("/2a098270-0739-11ed-a2dc-0242fe3e4a3f.png")} alt="add" /></p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" width={700} src={useBaseUrl("/2a198800-0739-11ed-a2dc-0242fe3e4a3f.png")} alt="add input" /> </p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" width={700} src={useBaseUrl("/2a298d90-0739-11ed-a2dc-0242fe3e4a3f.png")} alt="wait for page load" /> </p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" width={700} src={useBaseUrl("/2a39ba30-0739-11ed-a2dc-0242fe3e4a3f.png")} alt="add wait keyword" /></p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" width={600} src={useBaseUrl("/2a4a0de0-0739-11ed-a2dc-0242fe3e4a3f.png")} alt="add wait for element present" /></p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" width={600} src={useBaseUrl("/2a59ec60-0739-11ed-a2dc-0242fe3e4a3f.png")} alt="test case" /></p> 
