...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">To send test summary reports via email, first you need to   configure the <a className="xref" href="/docs/katalon-studio-enterprise/create-tests-and-projects/manage-projects/project-settings/email-settings">Email     Settings</a>. You need to set up a mail server, an email template,   and a default recipient list.</p> 
...
<div xmlns="http://www.w3.org/1999/xhtml" className="note note note_note"><span className="note__title">Note:</span> <p className="p">See also <a className="xref" href="/docs/katalon-runtime-engine/command-syntax-command-lineconsole-mode-execution">Execute
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">You can centralize test results including logs and attachments   on <a className="xref" href="/docs/katalon-studio-enterprise/integration/testops-integration/upload-test-results-to-katalon-testops-from-katalon-studio">Katalon     TestOps</a>. Besides test results management, Katalon TestOps will   also provide analytics to improve the quality of your test   cases.</p> 
