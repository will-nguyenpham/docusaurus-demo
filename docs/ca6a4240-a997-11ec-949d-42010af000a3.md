---
id: "ca6a4240-a997-11ec-949d-42010af000a3"
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">In version 7.6, Katalon Studio fully support <a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/locators_object_identification.html" target="_blank">selector     strategies supported by Appium except for Android Data     Matcher</a>.</p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">We recommend creating a Mobile object by using <a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/spy-mobile-utility.html" target="_blank">Katalon Mobile Spy</a> since the object locators are captured automatically for detecting objects during test execution.</p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">Katalon Studio 7.6+ fully supports <a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/locators_object_identification.html" target="_blank">selector strategies supported by Appium except for Android Data Matcher</a>.</p> 
<p xmlns="http://www.w3.org/1999/xhtml" className="p"> <img className="image" src={useBaseUrl("https://github.com/katalon-studio/docs-images/raw/master/katalon-studio/docs/manage-mobile-test-object./object.png")} /><br /><br /> </p> 

### <a id="id_3" class="anchor_top_offset"/>Validate Test Object on AUT

<p xmlns="http://www.w3.org/1999/xhtml" className="p">You can add test objects to <span className="ph uicontrol">Mobile Object Spy</span> to verify if the object can be detected successfully in the application under test. Refer to <a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/spy-mobile-utility.html" target="_blank">Spy Mobile Utility</a> for more details regarding how to validate captured objects against the application under test.</p> 
