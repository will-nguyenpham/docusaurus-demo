...
slug: "plugins-and-addons/katalon-store/katalon-studio-plugins/example-plugin-build-katalon-studios-testrail-integration-plugin"
hide_title: true
---
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">Please note, this document is not about how to use the plugin.   Please visit <a className="xref" href="/test-management/integration-for-test-management/configure-testrail-integration-in-katalon-studio">TestRail     integration document</a> if you need help.</p> 
