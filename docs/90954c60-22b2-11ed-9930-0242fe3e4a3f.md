...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">This document is not about how to use the plugin.   Visit <a className="xref" href="/organize/integration-for-organizing-tests/configure-testrail-integration-in-katalon-studio">TestRail     integration document</a> if you need help.</p> 
