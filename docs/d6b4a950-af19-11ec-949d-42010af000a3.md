---
id: "d6b4a950-af19-11ec-949d-42010af000a3"
title: "[Mobile] Run iOS App in Background and Wait"
slug: "katalon-studio-enterprise/keywords/mobile-keywords/mobile-run-ios-app-in-background-and-wait"
hide_title: true
---

# <a id="id_0" class="anchor_top_offset"/><a id="ariaid-title1" class="anchor_top_offset"/>[Mobile] Run iOS App in Background and Wait
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">Running the active application in the background.</p> 
      
<div xmlns="http://www.w3.org/1999/xhtml" className="note note note_note"><span className="note__title">Note:</span> 
  <p className="p">This keyword is used for iOS application only.</p>
</div>
