---
id: "f1b67740-d752-11ec-a2dc-0242fe3e4a3f"
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">To view test reports on TestOps, you can enable Katalon TestOps   integration in your project. See: <a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/testops-integration.html" target="_blank">TestOps     Integration</a>.</p> 
