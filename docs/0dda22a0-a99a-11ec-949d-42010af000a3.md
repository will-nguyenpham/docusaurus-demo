---
id: "0dda22a0-a99a-11ec-949d-42010af000a3"
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">You can also use the captured screenshots (screenshots taken as checkpoints) for visual testing with TestOps Visual Testing. See: <a className="xref j-external-link" href="https://docs.katalon.com/katalon-analytics/docs/ks-visual-testing.html" target="_blank">Visual     Testing</a>.</p> 
...
<div xmlns="http://www.w3.org/1999/xhtml" className="p">If you wish to manually set the conditions for capturing screenshots during tests, you can use the following built-in keywords for Web UI and Mobile testing:
  <ul className="ul"><li className="li"><a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/webui-take-screenshot.html" target="_blank">[WebUI] Take Screenshot</a></li><li className="li"><a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/webui-take-screenshot-as-checkpoint.html" target="_blank">[WebUI] Take Screenshot As Checkpoint</a> (Available from 7.7)</li><li className="li"><a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/webui-take-area-screenshot-as-checkpoint.html" target="_blank">[WebUI] Take Area Screenshot As Checkpoint</a> (Available from 7.7)</li><li className="li"><a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/webui-take-area-screenshot.html" target="_blank">[WebUI] Take Area Screenshot</a> (Available from 7.7)</li><li className="li"><a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/webui-take-element-screenshot-as-checkpoint.html" target="_blank">[WebUI] Take Element Screenshot As Checkpoint</a> (Available from 7.7)</li><li className="li"><a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/webui-take-element-screenshot.html" target="_blank">[WebUI] Take Element Screenshot</a> (Available from 7.7)</li><li className="li"><a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/webui-take-fullpage-screenshot-as-checkpoint.html" target="_blank">[WebUI] Take Full Page Screenshot As Checkpoint</a> (Available from 7.7)</li><li className="li"><a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/webui-take-fullpage-screenshot.html" target="_blank">[WebUI] Take Full Page Screenshot</a> (Available from 7.7)</li><li className="li"><a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/mobile-take-screenshot.html" target="_blank">[Mobile] Take Screenshot</a></li></ul>
</div>
...
<div xmlns="http://www.w3.org/1999/xhtml" className="p">See also:
  <ul className="ul"><li className="li"><a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/record-screen-based-videos.html" target="_blank">Record Screen-based Videos</a></li><li className="li"><a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/record-browser-based-videos.html" target="_blank">Record Browser-based Videos</a></li></ul>
</div>
