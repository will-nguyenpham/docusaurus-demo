...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">You can link a Test Run to a Build (or a Release). See: <a className="xref" href="/docs/katalon-testops/test-planning/releases#id_5">Link Test Runs to a Release</a>.</p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">See also: <a className="xref" href="/docs/katalon-testops/test-planning/releases">Manage Test Runs by Release</a>.</p> 
