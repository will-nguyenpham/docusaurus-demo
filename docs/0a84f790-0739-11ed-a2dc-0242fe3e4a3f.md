---
id: "0a84f790-0739-11ed-a2dc-0242fe3e4a3f"
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" src={useBaseUrl("/0a8c98b0-0739-11ed-a2dc-0242fe3e4a3f.png")} alt="Execution Settings" /></p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" src={useBaseUrl("/194b9ef0-0739-11ed-a2dc-0242fe3e4a3f.png")} alt="Launch Argument in execution settings" /></p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" src={useBaseUrl("/1959cfc0-0739-11ed-a2dc-0242fe3e4a3f.png")} alt="VM arguments example" /></p> 
<p xmlns="http://www.w3.org/1999/xhtml" className="p">To make sure if the configuration works,  add this simple test case:</p> 
<div xmlns="http://www.w3.org/1999/xhtml" className="p">
  <pre className="pre codeblock"><code>import com.kms.katalon.core.util.KeywordUtil{"\n"}KeywordUtil.logInfo(System.getProperty("testme")) </code></pre><img className="image" src={useBaseUrl("/19680090-0739-11ed-a2dc-0242fe3e4a3f.png")} alt="Example test case" />
</div>
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" src={useBaseUrl("/197f0b00-0739-11ed-a2dc-0242fe3e4a3f.png")} alt="WebUI settings" /></p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" src={useBaseUrl("/08dfac00-0739-11ed-a2dc-0242fe3e4a3f.png")} alt="Web Service settings" /></p> 
...
<p xmlns="http://www.w3.org/1999/xhtml" className="p"><img className="image" src={useBaseUrl("/08eddcd0-0739-11ed-a2dc-0242fe3e4a3f.png")} alt="A test request view" /></p> 
