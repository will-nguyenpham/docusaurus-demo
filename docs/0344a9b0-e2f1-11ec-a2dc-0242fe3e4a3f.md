...
<p xmlns="http://www.w3.org/1999/xhtml" className="p">You can create a new Release or use an existing Release. See: <a className="xref" href="/docs/katalon-testops/test-planning/releases">Manage Test Runs by Releases</a>.</p> 
