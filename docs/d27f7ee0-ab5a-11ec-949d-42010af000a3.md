---
id: "d27f7ee0-ab5a-11ec-949d-42010af000a3"
...
<div xmlns="http://www.w3.org/1999/xhtml" className="note attention note_attention"><span className="note__title">Attention:</span> 
  <p className="p">Katalon Studio partially supports Flutter-based applications. If
    ...
    Katalon Studio partially supports elements capturing.</p>
</div>
...
<ul xmlns="http://www.w3.org/1999/xhtml" className="ul">   <li className="li">     <a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/mobile-switch-to-native.html" target="_blank">Switch       to Native</a>   </li>   <li className="li">     <a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/mobile-switch-to-web-view.html" target="_blank">Switch       to WebView</a>   </li> </ul> 
...
<ul xmlns="http://www.w3.org/1999/xhtml" className="ul">   <li className="li">     <a className="xref j-external-link" href="https://docs.katalon.com/katalon-studio/docs/capture-elements-in-hybrid-android-apps.html" target="_blank">Capture       elements in hybrid Android apps</a>   </li> </ul> 
